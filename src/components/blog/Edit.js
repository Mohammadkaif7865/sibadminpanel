...
function BlogEdit() {
    ...
    return (
      <Layout>
        ...
        <h4 className="fw-bold py-3 mb-4"><span className="text-muted fw-light"></span> Blog Edit</h4>
        <div className="row">
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                  ...
                  <div className="mb-3">
                    ...
                    <textarea className="form-control" name="meta_description" onChange={handleInputChange} value={inputs.meta_description}></textarea>
                  </div>
